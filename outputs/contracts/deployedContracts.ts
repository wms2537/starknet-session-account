...
const deployedContracts = {
  devnet: {
    NexAccount: {
      ...
      abi: [
        ...
        },
        {
          type: "impl",
          name: "AccountImpl",
          interface_name: "contracts::nex_account::INexAccount",
        },
        {
          type: "interface",
          name: "contracts::nex_account::INexAccount",
          items: [
            {
              type: "function",
    ...
    MyAccount: {
      address:
        "0xadf71d8a463592c275eb4fc22491c3d88f52e5e82f63048001dfbe7e874f0f",
      abi: [
        {
          type: "impl",
          name: "UpgradeableImpl",
  ...
  sepolia: {
    NexAccount: {
      address:
        "0x3b7666d4a21ac250fe9e95a7c9ebcb602ae3dc566dc67fa503ddc6e24938f59",
      abi: [
        {
          type: "impl",
          name: "UpgradeableImpl",
